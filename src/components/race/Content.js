    ...
    render () {
        ...
        return (
            <div>
                ...
                {
                    current === 2 ? <Confirm handleClickChange={this.onClickTap} collapse={this.props.collapse} event={this.props.event} products={this.state.products} tickets={tickets}></Confirm> : null
                }
            </div >
        );
    }
